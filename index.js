...
const cleanBlacklist = require("./src/helpers/cleanBlacklist");
...
(async () => {
  ...
  // database'deki blacklist token'lardan env'deki REFRESH_EXP'ten uzun suredir mevcut olanlari sil
  ...
  // ? Authentication(Cookie - JWT Combined)
